  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-16">
      ...
      <section className="mb-16">
        <div className="card border-l-4 border-l-amber-400 bg-gradient-to-r from-amber-400/5 to-transparent">
          ...
          <p className="text-zinc-500 text-sm">— The FairPrint Mission</p>
        </div>
      </section>
      ...
      <section className="mb-16">
        ...
        <p className="text-zinc-400 mb-8">Everyone. But especially:</p>
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
          {whoWeHelp.map(({ emoji, group, detail }) => (
            <div key={group} className="card border-zinc-700 hover:border-zinc-600 transition-colors">
              <div className="text-3xl mb-3">{emoji}</div>
              <div className="text-white font-semibold text-sm mb-1">{group}</div>
              <div className="text-zinc-500 text-xs leading-tight">{detail}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="mb-16">
        ...
        <p className="text-zinc-400 mb-8">The principles behind every design decision.</p>
      ...
      <section className="mb-16">
        <div className="card border-zinc-700 text-center">
