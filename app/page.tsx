    ...
    <>
      ...
      <section className="py-24 px-4">
        <div className="max-w-4xl mx-auto">
          <div className="card border-l-4 border-l-blue-500 bg-gradient-to-r from-blue-500/5 to-transparent">
      ...
      <section className="py-24 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            {/* Connector line */}
            <div className="hidden md:block absolute top-8 left-[calc(16.66%+2rem)] right-[calc(16.66%+2rem)] h-px bg-gradient-to-r from-blue-500/50 via-teal-500/50 to-purple-500/50" />

            {steps.map(({ step, icon: Icon, title, description }, i) => (
              <div key={step} className="relative text-center">
                <div className="relative inline-flex items-center justify-center w-16 h-16 bg-slate-900 border-2 border-blue-500/40 rounded-2xl mb-5 mx-auto">
